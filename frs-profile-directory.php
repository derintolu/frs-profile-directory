 ...
 */
function has_remote_data_blocks(): bool {
...
function init(): void {
    ...
    // Load Remote Data Blocks integration if available
    require_once FRS_DIRECTORY_DIR . 'includes/class-remote-data-source.php';
    RemoteDataSource::init();

    if (has_remote_data_blocks()) {
        require_once FRS_DIRECTORY_DIR . 'includes/class-remote-queries.php';
        RemoteQueries::init();
    }
...
function register_settings(): void {
    ...
    register_setting('frs_directory_settings', 'frs_directory_api_key', [
        'type' => 'string',
        'sanitize_callback' => 'sanitize_text_field',
        'default' => '',
    ]);
